...
public:
	...
	enum PCD_Register {
		...
		Reserved00Reg			= 0x00,			// reserved for future use
	...
	enum PCD_RxGain {
		RxGain_18dB				= 0x02 << 4,	// 010b - 18 dB, it seems 010b is a duplicate for 000b
		RxGain_23dB				= 0x03 << 4,	// 011b - 23 dB, it seems 011b is a duplicate for 001b
	...
	byte PCD_CommunicateWithPICC(PCD_Command command, byte waitIRq, byte *sendData, 
	...
	byte PICC_REQA_or_WUPA(PICC_Command command, byte *bufferATQA, byte *bufferSize);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	byte PCD_Authenticate(PICC_Command command, byte blockAddr, MIFARE_Key *key, Uid *uid);
