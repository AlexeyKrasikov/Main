...
#define assertln(x)                 Serial.println(x); delay(5)
#define assert2(x, y)               Serial.print(x, y)
#define assert2ln(x, y)             Serial.println(x, y); delay(5)
#define assertF(x)                  Serial.print(F(x))
#define assertlnF(x)                Serial.println(F(x)); delay(5)
#define assert2F(x, y)              Serial.print(F(x), y)
#define assert2lnF(x, y)            Serial.println(F(x), y); delay(5)
